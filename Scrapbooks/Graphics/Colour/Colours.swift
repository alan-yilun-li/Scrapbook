...
extension UIColor {
    ...
    static let scrapbooksYellow = UIColor(red: 255/255, green: 211/255, blue: 0/255, alpha: 1.0)
    ...
    static let scrapbooksBrown = UIColor(red: 105/255, green: 85/255, blue: 75/255, alpha: 1.0)
...
struct Colours {
    ...
    static func fill(navigationBar: UINavigationBar) {
        navigationBar.barTintColor = UIColor.scrapbooksYellow
        navigationBar.tintColor = UIColor.maroon
    }
